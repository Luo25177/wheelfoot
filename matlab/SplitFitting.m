...
Lw = [];
Lb = [];
for len = 0.18 : 0.01 : 0.36
    [ml, IL,  Lw_, Lb_, phi1] =  GetLegBaryCenterAndPhiCompensate(len); 
    phis = [phis, phi1];
    L = [L, len];
    I = [I, IL];
    Lw = [Lw, Lw_];
...
Kphi = polyfit(L, phis, 3);
valKphi = polyval(Kphi, L);
figure(1);hold on;plot(L , phis, 'r*', L, valKphi, 'b-.');
...
Kk11 = polyfit(L_ranges, K11', 3);
Kk12 = polyfit(L_ranges, K12', 3);
Kk13 = polyfit(L_ranges, K13', 3);
Kk14 = polyfit(L_ranges, K14', 3);
Kk15 = polyfit(L_ranges, K15', 3);
Kk16 = polyfit(L_ranges, K16', 3);

Kk21 = polyfit(L_ranges, K21', 3);
Kk22 = polyfit(L_ranges, K22', 3);
Kk23 = polyfit(L_ranges, K23', 3);
Kk24 = polyfit(L_ranges, K24', 3);
Kk25 = polyfit(L_ranges, K25', 3);
Kk26 = polyfit(L_ranges, K26', 3);
